    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        <li class="nav-item d-none d-md-block"><a
                                class="nav-link 
       sidebartoggler waves-effect waves-light"
                                href="javascript:void(0)" data-sidebartype="mini
       sidebar"><i
       ...
       effect waves-dark"
                                href="javascript:void(0)" aria-expanded="false"><i
                                    class="mdi mdi
       shopping"></i><span class="hide-menu">Data Produk
                                </span></a>
...
right"></i><span class="hide-menu"> Produk </span></a></li> 
    ...
    <!-- this page js -->
    <script src="{{ asset('backends/extra-libs/multicheck/datatable-checkbox-init.js') }}"></script>
    <script src="{{ asset('backends/extra-libs/multicheck/jquery.multicheck.js') }}"></script>
